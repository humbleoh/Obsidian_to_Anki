...
export const OBS_INLINE_MATH_REGEXP: RegExp = /(?<!\$)\$((?=[\S])(?=[^$])[^$]*?\S)\$/g
...
code:not(pre code){background:#f5f5f5;padding:0.15em 0.3em;border-radius:3px;border:1px solid #ddd;font-family:'Inconsolata',monospace;font-size:0.9em}
.hljs{display:block;overflow-x:auto;padding:0.5em;background:#fdf6e3;color:#657b83;font-size:12px;font-family:monospace;line-height:1.3;border:1px solid #ccc;border-radius:4px;-webkit-text-size-adjust:none}
